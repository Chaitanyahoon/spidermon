...
const certs = [
  { title: "Google Cloud Professional", issuer: "Google", tag: "Google", date: "Jun 2023", url: "https://cloud.google.com/certification", accent: true },
  { title: "Azure Fundamentals", issuer: "Microsoft", tag: "Microsoft Learn", date: "Mar 2023", url: "https://docs.microsoft.com/en-us/learn/certifications/azure-fundamentals/", accent: false },
  { title: "Data Science Certification", issuer: "Tata", tag: "Tata / Forage", date: "Dec 2022", url: undefined, accent: false },
  { title: "Full Stack Development", issuer: "Cognizant", tag: "Cognizant / Forage", date: "Sep 2022", url: undefined, accent: false },
];

const issuerInitials: Record<string, string> = {
  Microsoft: "MS", Tata: "TA", Google: "GO", Cognizant: "CG",
};

export default function Certificates() {
  return (
    <section id="certificates" className="bg-[var(--theme-bg)] border-t border-zinc-800/60 px-6 md:px-16 lg:px-24 py-24">
      <motion.div
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
        ...
        >
          Industry-recognised credentials across cloud, AI, and data from Microsoft, Google, and more.
        </motion.p>
      </div>
